/**
 * MCP tool handlers for scribe.js document tools.
...
const { buildStructuredPageText } = await import(pathToFileURL(resolve(__dirname, '..', 'js', 'utils', 'structuredText.js')).href);
